...
export class CustomRoll {
	...
	*/
	static async rollMultiple(numRolls = 1, dice = "1d20", parts = [], data = {}, title = "", critThreshold, rollState, triggersCrit = false, rollType = "") {
		...
		let multiRoll = await renderTemplate("modules/betterrolls_kryx_rpg/templates/red-multiroll.html", chatData);
	...
	static async eventToAdvantage(ev, itemType) {
		...
		} else if (game.settings.get("betterrolls_kryx_rpg", "queryAdvantageEnabled")) {
...
export class CustomItemRoll {
	...
	updateConfig() {
		this.config = {
			playRollSounds: game.settings.get("betterrolls_kryx_rpg", "playRollSounds"),
			hasMaestroSound: hasMaestroSound(this.item),
			damageRollPlacement: game.settings.get("betterrolls_kryx_rpg", "damageRollPlacement"),
			rollTitlePlacement: game.settings.get("betterrolls_kryx_rpg", "rollTitlePlacement"),
			damageTitlePlacement: game.settings.get("betterrolls_kryx_rpg", "damageTitlePlacement"),
			damageContextPlacement: game.settings.get("betterrolls_kryx_rpg", "damageContextPlacement"),
			contextReplacesTitle: game.settings.get("betterrolls_kryx_rpg", "contextReplacesTitle"),
			contextReplacesDamage: game.settings.get("betterrolls_kryx_rpg", "contextReplacesDamage"),
			...
			quickDefaultDescriptionEnabled: game.settings.get("betterrolls_kryx_rpg", "quickDefaultDescriptionEnabled"),
			altSecondaryEnabled: game.settings.get("betterrolls_kryx_rpg", "altSecondaryEnabled"),
