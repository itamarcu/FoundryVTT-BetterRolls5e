...
export class BetterRollsHooks {
  ...
  */
  static registerActorSheet ( // SHEET CREATORS SHOULD NO LONGER USE THIS!
    ...
    Hooks.on(sheetString, (app, html, data) => {
      game.settings.get('betterrolls_kryx_rpg', 'rollButtonsEnabled')
        ? addItemSheetButtons(app.object, html, data, triggeringElement,
        buttonContainer)
        : null
      game.settings.get('betterrolls_kryx_rpg', 'diceEnabled')
  ...
  */
  static addItemContent (actor, html,
    ...
    (game.settings.get('betterrolls_kryx_rpg', 'rollButtonsEnabled') &&
      triggeringElement && buttonContainer) ? addItemSheetButtons(actor, html,
      null, triggeringElement, buttonContainer) : null;
    (game.settings.get('betterrolls_kryx_rpg', 'diceEnabled') && itemButton)
